...
namespace Editor.UnityCI {
    ...
    /// </summary>
#if NETSTANDARD
    public class SemVersion : IComparable<SemVersion>, IComparable
#else
    [Serializable]
    public class SemVersion : IComparable<SemVersion>, IComparable, ISerializable
#endif
    {
        ...
        public SemVersion MajorMinorPatch => new SemVersion(Major, Minor, Patch);

        public SemVersion MajorMinor => new SemVersion(Major, Minor);
        ...
        public Dictionary<string, string> ToDictionary() {
            return new Dictionary<string, string>() {
                {"number", MajorMinorPatch.ToString() },
